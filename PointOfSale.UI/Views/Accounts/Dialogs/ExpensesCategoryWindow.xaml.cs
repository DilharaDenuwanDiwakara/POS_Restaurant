...
namespace PointOfSale.UI.Views.Accounts.Dialogs
{
    /// <summary>
    /// Interaction logic for ExpensesCategoryWindow.xaml
    /// </summary>
    public partial class ExpensesCategoryWindow : Window
    {
        public ExpensesCategoryWindow()
        {
            InitializeComponent();
        }
